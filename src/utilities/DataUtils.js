...
const getMostFrequentWeather=(arr)=> {
...
const getWeekForecastWeather = (response, descriptions_list) => {
  let foreacast_data = [];
...
export{groupBy,getAverage,getMostFrequentWeather, descriptionToIconName,getWeekForecastWeather,getTodayForecastWeather}